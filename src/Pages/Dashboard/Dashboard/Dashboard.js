        ...
        <div style={ { backgroundColor: "rgba(193,164,130,.3)", minHeight: "100vh" } }>
            ...
            <Box style={ { paddingLeft: "10px" } }>
                <Box>
                    ...
                    <Box style={ { textAlign: "left" } }>
                        <Link style={ { textDecoration: "none", color: "#757575" } } to={ `/dashboard` }>
                ...
                </Box>
                {
                    admin && <Box style={ { textAlign: "left" } }>
                        ...
                        <Box>
                            <Link style={ { textDecoration: "none", color: "#757575" } } to={ `/dashboard/addProduct` }>
                                <Button color="inherit">Add Product</Button>
                            </Link>
                        </Box>
                        <Box>
                            <Link style={ { textDecoration: "none", color: "#757575" } } to={ `/dashboard/manageProducts` }>
